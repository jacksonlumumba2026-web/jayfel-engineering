...
Real photos are in place for the logo, `site-team.jpg`, and 3 certificates (incorporation,
NCA road works license, NCA road works registration). Every other image in `src/assets/`
is still one of Lovable's branded placeholder graphics (charcoal + red diagonal stripes,
labelled "REPLACE WITH REAL PHOTO") — the real photos didn't come through in the original
upload.
